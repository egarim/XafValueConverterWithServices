...
using XafValueConverterWithServices.Blazor.Server.Services;
using DevExpress.Persistent.BaseImpl.PermissionPolicy;
using XafValueConverterWithServices.Module.BusinessObjects;

namespace XafValueConverterWithServices.Blazor.Server;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<XafValueConverterWithServicesBlazorApplication>();
            builder.Modules
                .AddCloningXpo()
            	...
            	.Add<XafValueConverterWithServicesBlazorModule>();
